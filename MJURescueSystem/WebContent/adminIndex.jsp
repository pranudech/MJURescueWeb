...
<!-- Menu Bar -->
	...
	<a href="adminIndex.jsp" class="w3-padding w3-text-teal"><i class="fa fa-home" aria-hidden="true"></i>&nbsp;&nbsp;&nbsp;&nbsp;หน้าหลัก</a>
	<a href="adminIndexStudent.jsp" class="w3-padding"><i class="fa fa-user" aria-hidden="true"></i>&nbsp;&nbsp;&nbsp; นักศึกษา</a>
	<a href="adminIndexAID.jsp" class="w3-padding"><i class="fa fa-medkit" aria-hidden="true"></i>&nbsp;&nbsp;&nbsp;การปฐมพยาบาลเบื้องต้น</a>
 	<a href="adminIndexStaff.jsp" class="w3-padding"><i class="fa fa-street-view" aria-hidden="true"></i>&nbsp;&nbsp;&nbsp;จัดการข้อมูล STAFF</a>
...
<!-- Header -->
		...
		<h2>
			<font color="#2F4F4F"><b>&nbsp;&nbsp;Administration</b>&nbsp;&nbsp;<i class="fa fa-user-plus" aria-hidden="true"></i></font>
		</h2>
