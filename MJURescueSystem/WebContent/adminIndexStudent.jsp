...
<html>
<head>
<title>ADMIN INDEX STUDENT</title>
...
<!-- Header -->
		...
		<h2>
			<font color="#2F4F4F"><b>&nbsp;&nbsp;Student Management</b>&nbsp;&nbsp;<i class="fa fa-graduation-cap" aria-hidden="true"></i></font>
		</h2>
...
<!-- Content -->
		<div>
			<img src="img/Students_Index.png" style="width: 50%; margin-left: 275px">
		</div>
